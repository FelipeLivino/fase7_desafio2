...
Este projeto é uma solução completa que consolida todas as fases desenvolvidas durante o curso FIAP, incluindo sistemas de gestão, monitoramento IoT, machine learning e detecção de objetos com visão computacional.
